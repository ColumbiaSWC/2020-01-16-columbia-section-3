...
venue: "Columbia University (Butler Library, Room 213)"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Butler Library, 535 West 114th Street, Room 213"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["David Balducci", "Michael Introini", "Paul Bloom", "Thomas Barraro"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dali Plavsic","Eric Vlach","David Balducci","Shanice Bailey","Mengzhen Sun", "Richard Warren"]
